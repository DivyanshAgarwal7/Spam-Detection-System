...
exports.gmailAuthUrl = async (req, res) => {
  try {
...
exports.gmailConnect = async (req, res) => {
  try {
    const { code } = req.query;
    if (!code) {
      return res.status(400).json({ error: "Authorization code is missing" });
...
exports.gmailEmails = async (req, res) => {
  try {
...
exports.outlookAuthUrl = async (req, res) => {
  try {
...
exports.outlookConnect = async (req, res) => {
  try {
    const { code } = req.query;
    if (!code) {
      return res.status(400).json({ error: "Authorization code is missing" });
...
exports.outlookEmails = async (req, res) => {
  try {
